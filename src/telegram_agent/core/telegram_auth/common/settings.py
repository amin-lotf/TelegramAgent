...
from telegram_agent.core.telegram_auth.common.const import DEFAULT_SQLALCHEMY_DATABASE_URL, DEFAULT_ALLOWED_ORIGINS
...
class Settings(BaseSettings):
    ...
    bot_verify_secret: str = Field(
        default="secret",
        validation_alias=AliasChoices("BOT_VERIFY_SECRET", "bot_verify_secret"),
        description="Secret key for verifying bot requests.",
    )

    bot_verify_hash: str = Field(
        default="hash",
        validation_alias=AliasChoices("BOT_VERIFY_HASH", "bot_verify_hash"),
        description="Hash of the secret key for verifying bot requests.",
    )
