"""Read-only table mappings for telegram-ingress (no service model import)."""
...
attachments = Table(
    ...
    Column("file_unique_id", String(255), nullable=True),
